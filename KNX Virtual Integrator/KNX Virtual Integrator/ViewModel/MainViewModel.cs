...
public class MainViewModel : ObservableObject, INotifyPropertyChanged
{
    ...
    //lier ad et mod
    private readonly IAddressModelLinker _addressModelLinker;
    ...
    //Lier modele et addr
    private string _linkadmodResult;
    public string LinkAdModResult
    {
        get => _linkadmodResult;
        set
        {
            if (_linkadmodResult != value)
            {
                _linkadmodResult = value;
                OnPropertyChanged(nameof(LinkAdModResult));
            }
        }
    }
    ...
    public MainViewModel(ModelManager modelManager)
    {
        ...
        _addressModelLinker = _modelManager.AddressModelLinker; //lier mode et adr
        ...
        //Lier Ad et mod
        LinkAdMod = new RelayCommand(
            async () =>
            {
                LinkAdModResult = await _addressModelLinker.GetFormattedLinkResultInString();
            });
    ...
    /// <summary>
    /// Lier les modèles et les address.
    /// </summary>
    /// 
    public RelayCommand LinkAdMod { get; private set; }
